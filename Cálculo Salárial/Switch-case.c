...
int main(void) {
    float sal = 0, lq = 0, inss = 0, fgts = 0, transporte = 0, saude = 0, desconto = 0, alimentacao = 0, cal = 0, alq = 0, impr = 0, impr1 = 0, dep = 0, ferias = 0, fgts_prov = 0, prev = 0, custo_em = 0, Acidente_trab = 0, Sal_Educ = 0;
    ...
    switch (sal <= 2112.00 ? 1 : sal <= 2826.65 ? 2 : sal <= 3751.05 ? 3 : sal <= 4664.68 ? 4 : 5) {
        case 1:
            alq = 0;
            cal = 0;
            break;
    ...
    switch (sal <= 1412.00 ? 1 : sal <= 2666.68 ? 2 : sal <= 4000.03 ? 3 : sal <= 7786.02 ? 4 : 5) {
        case 1:
            inss = sal * 0.075;
            break;
        case 2:
    ...
    saude = sal * 0.05;
    alimentacao = sal * 0.10;
    transporte = sal * 0.06; //A empresa arca com 8% e o funcionário com 6%

    fgts = sal * 0.08;
    desconto = inss + saude + transporte + impr1 + alimentacao - dep;
